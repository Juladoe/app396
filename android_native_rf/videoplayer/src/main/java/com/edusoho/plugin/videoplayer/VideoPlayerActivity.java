...
public class VideoPlayerActivity extends VideoPlayer implements MediaPlayer.OnErrorListener,
    ...
    public static void readSettings(Activity context) {

        settings = context.getSharedPreferences(Globals.PREFS_NAME, MODE_PRIVATE);

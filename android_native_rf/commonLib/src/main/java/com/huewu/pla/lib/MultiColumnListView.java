...
public class MultiColumnListView extends PLA_ListView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            mColumnPaddingLeft = a.getDimensionPixelSize(R.styleable.PinterestLikeAdapterView_plaColumnPaddingLeft, mColumnPaddingLeft);
            mColumnPaddingRight = a.getDimensionPixelSize(R.styleable.PinterestLikeAdapterView_plaColumnPaddingRight, mColumnPaddingRight);
            a.recycle();
        }

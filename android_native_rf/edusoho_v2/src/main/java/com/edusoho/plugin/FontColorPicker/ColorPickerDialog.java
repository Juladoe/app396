...
public class ColorPickerDialog extends Dialog implements ColorPickerView.OnColorChangedListener, View.OnClickListener {
    ...
    private ImageView ivFontColorChecked;

    private ColorPickerPanelView mOldColor;
    private ColorPickerPanelView mNewColor;

    private Button mBtnDefaultFontColor;
    ...
    private void setUp(int color) {
        ...
        ivFontColorChecked = (ImageView) layout.findViewById(R.id.iv_font_color_check);
        mOldColor = (ColorPickerPanelView) layout.findViewById(R.id.old_color_panel);
        mNewColor = (ColorPickerPanelView) layout.findViewById(R.id.new_color_panel);

        mBtnSelected = (Button) layout.findViewById(R.id.btnSelected);
        mBtnDefaultFontColor = (Button) layout.findViewById(R.id.btn_default_font_color);
        ...
        mBtnDefaultFontColor.setOnClickListener(this);
        ivFontColorChecked.setOnClickListener(this);
    ...
    public void onColorChanged(int color) {
        ...
        Log.d("color_text---->", String.valueOf(color));
        mBtnSelected.setTextColor(color);
...
//        } else
//
        if (v.getId() == R.id.iv_font_color_check) {
            if (mListener != null) {
                mListener.onColorChanged(mBtnSelected.getTextColors().getDefaultColor());
            }
        } else if (v.getId() == R.id.btn_default_font_color) {
            mBtnSelected.setTextColor(Color.BLACK);
            mListener.onColorChanged(Color.BLACK);
        }

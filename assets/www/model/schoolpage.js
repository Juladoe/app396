define(function(require, exports){
	...
	/*
	<div title="添加网校" id="addschool" class="panel" data-footer='none'>
					 <ul class="list">
						<li class="divider" style="text-align:center;padding-right:1px;">
							<input id="searchWord" type="text" placeholder="输入域名添加网校 如(www.name.com)" style="width:98%;">
						</li>
						<li class="divider" style="text-align:center;padding-right:1px;">
							<span onclick="schoolpage_model.seachSchool('searchWord');" class="button white custom_button_blue">确 定</span>
						</li>
					 </ul>
	...
	*/
	...
	exports.seachSchool = function(schoolName)
	{
		var search = $("#" + schoolName).val();
		if (search.length < 3) {
			$("#afui").popup("请输入网校网址!");
			return;
		}

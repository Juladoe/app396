...
public class MyInfoPlugin {
    ...
    public static ArrayList<MyInfoPlugin> createNormalList(ActionBarBaseActivity mActivity) {
        ...
        list.add(new MyInfoPlugin(mActivity.getBitmap(R.drawable.myinfo_question), PluginEnum.QUESTION, "我的问答"));
        list.add(new MyInfoPlugin(mActivity.getBitmap(R.drawable.myinfo_discuss), PluginEnum.DISCUSS, "我的话题"));

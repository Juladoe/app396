...
public class TaskFinishHelper {
    ...
    public CourseTask.CourseTaskStatusEnum mTaskStatus = CourseTask.CourseTaskStatusEnum.DOING;
    ...
    public void finishTask() {
        mTaskStatus = CourseTask.CourseTaskStatusEnum.FINISH;
        submitTaskStatus();
    }
        ...
        HttpUtils.getInstance()
                ...
                .subscribe(new Subscriber<TaskEvent>() {
                    ...
                    public void onNext(TaskEvent taskEvent) {
                        if (CourseTask.CourseTaskStatusEnum.FINISH.toString().equals(taskEvent.result.status)) {
                            mTimer.cancel();
                        }
                    }
                });

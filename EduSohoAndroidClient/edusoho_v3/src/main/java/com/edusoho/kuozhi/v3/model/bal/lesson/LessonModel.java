...
public class LessonModel {
    public static void getLessonByCourseId(int courseId, String[] conditions, final ResponseCallbackListener<List<Lesson>> callbackListener) {
        String url = String.format(Api.LESSONS, courseId);
